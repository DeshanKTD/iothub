...
char* outTopic     = "arduinoOut/sense"; // * MQTT channel where physical updates are published
char* inTopic      = "arduinoIn/sense"; // * MQTT channel where lelylan updates are received
...
//    // Wait a few seconds between measurements.
  ...
  inputString = "Humidity-";
  inputString = inputString + h;
  inputString = inputString + " Tempearature-";
